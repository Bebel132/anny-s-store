...
const Cart = () => {
  ...
  return (
    <>
        <Menu selected="cart" />
        <div className="flex justify-center flex-col gap-3 max-w-[1250px] max-full m-auto pt-5 px-3">
            ...
            <div className="flex flex-col gap-3">
                {cartItems.map((item) => (
                    <div key={item.Id} className="p-2 w-full flex gap-5 border rounded border-gray-300">
                        <div
                            className={`max-w-[300px] w-full h-[200px] sm:h-[250px] bg-cover bg-center sm:bg-position-[center_top_-2rem] rounded-xl`}
                        ...
                        <div className="w-full">
                            ...
                            <div className="w-full flex justify-between items-center">
                                ...
                                <div className="flex flex-col sm:flex-row items-center">
                                    <button className="border rotate-90 sm:rotate-none px-1 bg-red-500 text-snow hover:bg-emerald cursor-pointer" onClick={() => handleCartChangePrice("decrease", item)}>&lt;</button>
                                    <span className="px-2 cursor-default">{item.Quantity}</span>
                                    <button className="border rotate-90 sm:rotate-none px-1 bg-green text-snow hover:bg-emerald cursor-pointer" onClick={() => handleCartChangePrice("increase", item)}>&gt;</button>
                                </div>
                            </div>
                        </div>
                    </div>
